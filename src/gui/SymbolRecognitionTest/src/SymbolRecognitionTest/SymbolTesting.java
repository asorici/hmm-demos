...
/**
 * The <code>SymbolTesting</code> class provides a Java interface to the M-functions
 * from the files:
 * <pre>
 ...
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>SymbolTesting</code> 
 * instance when it is no longer needed to ensure that native resources allocated by this 
 * class are properly freed.
 * @version 0.0
 */
public class SymbolTesting extends MWComponentInstance<SymbolTesting>
{
    /**
     ...
     */
    private SymbolTesting (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(SymbolTesting.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>SymbolTesting</code> class.
     */
    public SymbolTesting() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #SymbolTesting(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     */
    public SymbolTesting(String pathToComponent) throws MWException
    {
        this(SymbolRecognitionTestMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>SymbolTesting</code> class. Use this 
     * constructor to specify the options required to instantiate this component.  The 
     * options will be specific to the instance of this component being created.
     * @param componentOptions Options specific to the component.
     */
    public SymbolTesting(MWComponentOptions componentOptions) throws MWException
    {
