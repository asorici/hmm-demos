...
. SymbolRecognitionTest.jar must be included in your CLASSPATH.

. javabuilder.jar must be included in your CLASSPATH. javabuilder.jar 
  can be found in: 
  
  <mcr_root>*/toolbox/javabuilder/jar/glnx86/javabuilder.jar
  
 
2. Files to Deploy and Package

-SymbolRecognitionTest.jar
-MCRInstaller.zip 
   - include when building component by clicking "Add MCR" link 
     in deploytool
-Javadoc   
   - javadoc for SymbolRecognitionTest is in the doc directory. While  
