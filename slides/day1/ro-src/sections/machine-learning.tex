...
\begin{frame}[t]
  ...
  \begin{center}%
    ...
    \only<4>{\includegraphics[width=0.65\textwidth]{graphics/ml-intro/gripa}}%
  \end{center}
\end{frame}
...
\begin{frame}[t]
  ...
  \begin{center}
    ...
    \only<3>{\includegraphics[width=.45\textwidth]{graphics/ml-intro/car-2}}%
    \only<4>{\includegraphics[width=.45\textwidth]{graphics/ml-intro/car-1}}%
