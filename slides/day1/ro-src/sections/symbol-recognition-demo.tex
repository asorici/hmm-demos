...
\begin{frame}[t]
	...
	\only<1>{\centering \includegraphics[width=0.85\textwidth]{graphics/demo-app/symbol-app-architecture-1.pdf}}
	\only<2>{\centering \includegraphics[width=0.85\textwidth]{graphics/demo-app/symbol-app-architecture-2.pdf}}
	\only<3>{\centering \includegraphics[width=0.85\textwidth]{graphics/demo-app/symbol-app-architecture-3.pdf}}
	\only<4>{
		\centering \includegraphics[width=0.85\textwidth]{graphics/demo-app/symbol-app-architecture-4.pdf}	
	}
